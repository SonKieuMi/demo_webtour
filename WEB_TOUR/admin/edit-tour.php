...
$url = "http://";   
// Nối máy chủ (tên miền, ip) vào URL.
$url.= $_SERVER['HTTP_HOST'];   

// Nối vị trí tài nguyên được yêu cầu vào URL
$url.= $_SERVER['REQUEST_URI'];
// Sử dụng hàm parse_url () để phân tích cú pháp URL
// và trả về một mảng kết hợp
// chứa các thành phần khác nhau của nó
$url_components = parse_url($url);
  
// Sử dụng hàm parse_str () để phân tích cú pháp
// chuỗi được chuyển qua URL
